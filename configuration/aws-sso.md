...
2. **SSO start URL:** Enter the full URL for your AWS access portal (eg. `https://my-domain.awsapps.com/start`).
3. **SSO region:** Enter the region where your IAM Identity Center is located (`us-east-1`).
4. **SSO registration scopes:** You can leave this blank and press Enter.
...
sso_role_name = <YOUR-AWS-BEDROCK-ROLE>
region = us-east-1
